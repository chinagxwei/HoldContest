...
class BaseRoutesData
{
    ...
    public static function getSystemData($menus_id, $created_by)
    {
        ...
        return [
            [
                ...
                'navigation_router' => 'platform/system/banner',
                'navigation_sort' => 1,
                'icon' => 'line-chart',
    ...
    public static function getCompetitionData($menus_id, $created_by)
    {
        $time = time();
        return [
            [
                'parent_id' => $menus_id,
                'navigation_name' => '游戏管理',
                'navigation_link' => './system/competition-game',
                'navigation_router' => 'platform/system/competition-game',
                'navigation_sort' => 1,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '规则管理',
                'navigation_link' => './system/competition-rule',
                'navigation_router' => 'platform/system/competition-rule',
                'navigation_sort' => 2,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '房间管理',
                'navigation_link' => './system/competition-room',
                'navigation_router' => 'platform/system/competition-room',
                'navigation_sort' => 3,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '房间链接管理',
                'navigation_link' => './system/competition-room-link',
                'navigation_router' => 'platform/system/competition-room-link',
                'navigation_sort' => 3,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '团队管理',
                'navigation_link' => './system/competition-game-team',
                'navigation_router' => 'platform/system/competition-game-team',
                'navigation_sort' => 5,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
    ...
    public static function getActivityData($menus_id, $created_by)
    {
        $time = time();
        return [
            [
                'parent_id' => $menus_id,
                'navigation_name' => '任务管理',
                'navigation_link' => './system/quest',
                'navigation_router' => 'platform/system/quest',
                'navigation_sort' => 1,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '抽奖项管理',
                'navigation_link' => './system/lucky-draws-item',
                'navigation_router' => 'platform/system/lucky-draws-item',
                'navigation_sort' => 2,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '抽奖配置管理',
                'navigation_link' => './system/lucky-draws-config',
                'navigation_router' => 'platform/system/lucky-draws-config',
                'navigation_sort' => 3,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
    ...
    public static function getWalletData($menus_id, $created_by)
    {
        ...
        return [
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '提现金额配置管理',
                'navigation_link' => './system/wallet-withdrawal-amount-config',
                'navigation_router' => 'platform/system/wallet-withdrawal-amount-config',
                'navigation_sort' => 4,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
