...
class BaseRoutesData
{
    ...
    public static function getMemberData($menus_id, $created_by)
    {
        ...
        return [
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '会员游戏账户管理',
                'navigation_link' => './system/member-game-account',
                'navigation_router' => 'platform/system/member-game-account',
                'navigation_sort' => 4,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '会员任务记录管理',
                'navigation_link' => './system/member-quest',
                'navigation_router' => 'platform/system/member-quest',
                'navigation_sort' => 7,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
            ...
            [
                'parent_id' => $menus_id,
                'navigation_name' => '会员VIP记录管理',
                'navigation_link' => './system/member-vip',
                'navigation_router' => 'platform/system/member-vip',
                'navigation_sort' => 8,
                'icon' => 'line-chart',
                'created_by' => $created_by,
                'created_at' => $time,
