 ...
 * 图片列表
 */
export const IMAGE_LISTS = `${HOST}/api/${API_VERSION}/${API_ADMIN_MODULE}/image/index`;
 ...
 * 标签列表
 */
export const TARGET_LIST = `${HOST}/api/${API_VERSION}/${API_ADMIN_MODULE}/target/index`;
 ...
 * 单位列表
 */
export const UNIT_LIST = `${HOST}/api/${API_VERSION}/${API_ADMIN_MODULE}/unit/index`;
