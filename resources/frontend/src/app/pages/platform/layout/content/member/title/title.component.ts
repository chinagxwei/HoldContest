...
import {TitleService} from "../../../../../../services/member/title.service";
...
export class TitleComponent implements OnInit {
  ...
  currentData: Paginate<Title> = new Paginate<Title>();
  ...
  constructor(
    ...
    private componentService: TitleService
  ) {
