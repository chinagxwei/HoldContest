...
@Component({
  ...
  templateUrl: './product-recharge.component.html',
  styleUrls: ['./product-recharge.component.css']
})
export class ProductRechargeComponent implements OnInit {


  currentData: Paginate<ProductRecharge> = new Paginate<ProductRecharge>();
  ...
  initForm() {
    this.validateForm = this.formBuilder.group({
      ...
      denomination: [1, [Validators.required]],
      give_amount: [0],
  ...
  onDelete($event: ProductRecharge) {
